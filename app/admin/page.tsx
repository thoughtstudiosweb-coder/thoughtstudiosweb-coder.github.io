    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link
          ...
          className="block p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition"
        >
          <h2 className="text-xl font-semibold text-white mb-2">Site Content</h2>
          <p className="text-gray-400">Edit navigation labels, section headers, and footer content</p>
        </Link>
      </div>
    </div>
  )
