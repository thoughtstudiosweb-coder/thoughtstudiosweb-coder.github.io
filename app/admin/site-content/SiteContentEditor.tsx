  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Site Content</h1>
        <button
      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-gray-800 p-4 sm:p-6 rounded-lg">
          ...
          <p className="text-xs sm:text-sm text-gray-400 mb-4">These appear in the header navigation menu.</p>
        ...
        {/* Section Headers */}
        <div className="bg-gray-800 p-4 sm:p-6 rounded-lg">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Section Headers</h2>
          <p className="text-xs sm:text-sm text-gray-400 mb-4">These appear as the main title for each section on the page.</p>
        ...
        <div className="bg-gray-800 p-4 sm:p-6 rounded-lg">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Development Section Content</h2>
          <p className="text-xs sm:text-sm text-gray-400 mb-4">The intro and outro text for the "In Development" section.</p>
