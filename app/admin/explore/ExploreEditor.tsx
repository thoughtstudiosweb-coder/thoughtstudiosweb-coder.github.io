  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Edit Explore Section</h1>
        ...
        {explore.map((item, index) => (
          <div key={index} className="bg-gray-800 p-4 sm:p-6 rounded-lg space-y-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
              <h3 className="text-lg sm:text-xl font-semibold text-white">Card {index + 1}</h3>
              <button
                type="button"
